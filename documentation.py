...
def test_fancybox_plugin_script():
    """
    Test if function creates proper javascript-script output for fancybox activation on .fancybox class
    """
    raise NotImplementedError()
...
def test_generate_fancybox_link():
    ...
    Checks if this function creates proper link based on markdown information provided
    """
    raise NotImplementedError()
...
def test_article_generator_finalized():
    """
    This tests if main fancybox function for lightbox mechanism is working properly.
